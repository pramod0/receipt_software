...
public class newView extends javax.swing.JFrame {
    ...
    public newView() {
        ...
        jPanel3.setVisible(false);
         jPanel8.setVisible(false);
          Db db=Db.getDb();
         String var="receipt";
         ResultSet rs=db.executeQuery("select * from scount where code!=0");
         try{
             while(rs.next())
         {
             jComboBox2.addItem(rs.getString("code"));
         }
         }catch(Exception e){
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(jTextField2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE)
        ...
        jLabel23.setText(" Cource Name");

        jLabel26.setText("  Cource Code");
        ...
        jTabbedPane1.addTab("ADD Cource ", jPanel9);
        ...
        jTextArea1.setText("  If you want make modification \n  To this app, OR want to create\n  any other app , Contact\n\n  Mahendra : +919769694399\n\n  contact@sith.co.in\n  contact@suhradam.in ");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        Db db=Db.getDb();
        String id=null,date=null,rno=null;
        ...
        try{
            while(rs.next())
            {
                ...
                else
                {
                    ...
                    {
                        ResultSet rs1=db.executeQuery("select count from scount where sr=1");
                        try {
                            while(rs1.next())
                            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        ResultSet rs1=db.executeQuery("select * from fees where id="+"\""+str1+"\""+"");
        try{
            while(rs1.next())
            {
                jTextField16.setText(rs1.getString("totalfees"));
                jTextField15.setText(rs1.getString("feespaid"));
                jTextField17.setText(rs1.getString("feespending"));
            }
        }catch(Exception e){Logger.getLogger(newView.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Db db = Db.getDb();
        int c2 = 0;
        String c=null,cname=null;
        String index=(String) jComboBox2.getSelectedItem();
        String var=index;
        int in=jComboBox2.getSelectedIndex()+1;
        System.err.println(in);
        ResultSet rs=db.executeQuery("select * from scount where code="+"\""+var+"\""+"");
        try {
            while(rs.next())
            {  
                c=rs.getString("code");
                cname=rs.getString("cource");
                c2=Integer.parseInt(rs.getString("count"));
            }

        } catch (SQLException ex) {
            Logger.getLogger(newView.class.getName()).log(Level.SEVERE, null, ex);
        }
        String gid=ID.generateID(index,c,c2);
        //String gids=;
        jLabel20.setText(gid);
        //String std=ID.Std(index);
        int year2 = Calendar.getInstance().get(Calendar.YEAR);
        int year1=year2+1;
        String year=year2+"-"+year1;
        System.out.println(year);
        String cmd = "insert into student(id,Std,ayear,firstname,lastname) values (\""+gid+"\",\""+cname+"\",\""+year+"\", \""+jTextField1.getText()+"\", \""+jTextField2.getText()+"\");";
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        Db db=Db.getDb();
        String cmd = "insert into scount(cource,code,count) values (\""+jTextField18.getText()+"\", \""+jTextField19.getText()+"\",0);";
        if(db==null)
            System.err.println("I Dont Know");
        else
            db.executeUpdate(cmd);
            JOptionPane.showMessageDialog(null,"Cource Updated");
